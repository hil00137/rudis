...
type CrcFn64 = fn(u64, &u8, u64) -> u64;

/* Fill in a CRC constants table. */
fn crcspeed64little_init(crcfn: CrcFn64, table: &mut [[u64; 256]; 8]) {
    let mut crc: u64;
...
fn crcspeed64big_init(crcfn: CrcFn64, mut big_table: &mut [[u64; 256]; 8]) {
...
pub fn crcspeed64native_init(func: CrcFn64, table: &mut [[u64; 256]; 8]) {
